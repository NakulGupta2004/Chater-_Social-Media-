...
import darki from './images/dark-mode.png'
      ...
      <div className="window flex m">
        ...
        <div className="left ldimen m cw" style={dark}>
          <ul className="flex fc margin1 ">
            <l1 ><div className='flex-j-c'><img src={darki}  alt="" className='icon invert' onClick={change}/> <h3>SWITCH TO {text} MODE</h3></div></l1>
            <l1 ><div className='flex-j-c'><img src={Twitter}  alt="" className='icon invert' style={invert} /> <h3>Twitter</h3></div></l1>
